            ...
            <div className={styleConnexion['box']}>
                <div className={styleConnexion['container']}>
                    <span style={{ color: '#fff', textAlign: 'center' }}>
                        <Link to="/login" className={styleConnexion['lien']}>Have an account ?</Link>
                    </span>
                    <h1 className={styleConnexion['header']}>REGISTER</h1>
                    ...
                    <div className={styleConnexion['input-field']}>
                        <input type="password" className={styleConnexion['input']} placeholder="Confirm password" required />
                        <i className="bx bx-lock-alt"></i>
                    </div>
                    <div className={styleConnexion['input-field']}>
                        <input type="submit" className={styleConnexion['submit']} value="REGISTER" />
                    </div>
